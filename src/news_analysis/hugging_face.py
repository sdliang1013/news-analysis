...
from transformers import PreTrainedTokenizer, PreTrainedModel, BertForSequenceClassification, \
    BertTokenizerFast, TrainingArguments, Trainer, PreTrainedTokenizerBase
